(function () {
  ...
  ((i =
    ...
    (m =
      null != (T = document.createElement("div").style).transition ||
      null != T.webkitTransition ||
    ...
    (S = function () {
      ...
      if (!L && null != window.jQuery) {
        for (
          e = 0, L = !0, r = [], n = (i = ["html", "text"]).length;
          e < n;
          e++
        )
          ((t = i[e]),
              ...
              (function (t) {
                ...
                return (
                  ...
                  (window.jQuery.fn[t] = function (t) {
                    var n;
                    return null == t ||
                      (null != (n = this[0]) ? n.odometer : void 0) == null
    ...
    ((p = (function () {
      function t(e) {
        ...
        for (i in ((this.el.odometer = this), (p = t.options)))
          ((s = p[i]), null == this.options[i] && (this.options[i] = s));
        (null == (a = this.options).duration && (a.duration = o),
          (this.MAX_VALUES = (this.options.duration / d / l) | 0),
          this.resetFormat(),
          (this.value = this.cleanValue(
            null != (c = this.options.value) ? c : "",
          )),
          this.renderInside(),
          this.render());
        try {
          for (
            u = 0, h = (f = ["innerHTML", "innerText", "textContent"]).length;
            u < h;
            u++
          )
            ((r = f[u]),
                ...
                (function (t) {
                  Object.defineProperty(m.el, t, {
                    get: function () {
                      ...
                      return "innerHTML" === t
                        ? m.inside.outerHTML
                        : null != (e = m.inside.innerText)
                          ? e
                          : m.inside.textContent;
                    },
                    set: function (t) {
                      return m.update(t);
                    },
      ...
      return (
        ...
        (t.prototype.resetFormat = function () {
          var t, e, i, r, o, s, u, l;
          if (
            ((t = null != (u = this.options.format) ? u : n) || (t = "d"),
            !(i = a.exec(t)))
          )
          ...
          return (
            ...
            (this.format = { repeating: s, radix: o, precision: r })
          );
        }),
        ...
        (t.prototype.update = function (t) {
          ...
          if ((e = (t = this.cleanValue(t)) - this.value))
            return (
              ...
              e > 0
                ? $(this.el, "odometer-animating-up")
                : $(this.el, "odometer-animating-down"),
              this.stopWatchingMutations(),
              this.animate(t),
              this.startWatchingMutations(),
              setTimeout(function () {
        ...
        (t.prototype.animate = function (t) {
          return m && "count" !== this.options.animation
            ? this.animateSlide(t)
            : this.animateCount(t);
        }),
        ...
        (t.prototype.getDigitCount = function () {
          ...
          return Math.ceil(
            Math.log((e = Math.max.apply(Math, i)) + 1) / Math.log(10),
          );
        }),
        ...
        (t.prototype.animateSlide = function (t) {
          ...
          if (
            ((v = this.value),
            (l = this.getFractionalDigitCount(v, t)) &&
              ((t *= Math.pow(10, l)), (v *= Math.pow(10, l))),
            (i = t - v))
          ) {
            for (
              ...
              if (
                ((y = x(v / Math.pow(10, o - p - 1))),
                Math.abs((a = (u = x(t / Math.pow(10, o - p - 1))) - y)) >
                  this.MAX_VALUES)
              ) {
                for (
                  h = [],
              ...
              for (p = _ = 0, T = h.length; _ < T; p = ++_)
                ((d = h[p]), (h[p] = Math.abs(d % 10)));
              s.push(h);
            }
            for (
              this.resetDigits(), D = s.reverse(), p = E = 0, w = D.length;
              E < w;
              p = ++E
            )
              for (
                h = D[p],
                  ...
                  null == (b = this.ribbons)[p] &&
                    (b[p] = this.digits[p].querySelector(
            ...
            if (
              (y < 0 && this.addDigit("-"),
              null != (m = this.inside.querySelector(".odometer-radix-mark")) &&
    ...
    setTimeout(function () {
      ...
      if (window.odometerOptions) {
        for (t in ((i = window.odometerOptions), (r = []), i))
          ((e = i[t]),
            r.push(
              null != (n = p.options)[t] ? (n = p.options)[t] : (n[t] = e),
            ));
        return r;
      }
    }, 0),
    ...
    (null != (C = document.documentElement) ? C.doScroll : void 0) != null &&
